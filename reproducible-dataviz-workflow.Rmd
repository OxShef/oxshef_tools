...
If a dataviz tool allows researchers to meet **all** of the following criteria, it passes the **OxShef: dataviz** reproducability standards and is marked as such in the [table of dataviz tools](oxshef-tools.netlify.com/list-of-tools.html#table-of-tools). We strive to provide [dedicated training, tutorials and templates](training-tutorials-and-templates) for all tools that meet these criteria.
